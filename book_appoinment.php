...
<?php include('uptomenu.php'); ?>
	...
	<div class="recipient_reg" style="background-color:#272327;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Booking Appointment</h3>
			 ...
			 <div class="col-md-12">
					...
					<label>
						Category: <select name="expertise" required>
										...
										<option>Haematology and clinical pathology</option>
					...
					<label>
						Doctor: <select name="doctor" required>
										<option>-Select-</option>
										<option>Internal Medicine Specialist Doctors</option>
										<option>Heart Doctors</option>
										<option>Neurology Doctors</option>
										<<option>Orthopaedics Doctors</option>
										<option>Haematology and clinical apthology Doctors</option>
										<option>Psychiatry Doctors</option>
