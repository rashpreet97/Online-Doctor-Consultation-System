...
<div class="container-fluid">
	...
	<div class="login" style="background-color:#fff;">
		<h1 class="text-center" style="background-color:#272327;color: #fff;">Doctor Panel</h1>
			<div class="formstyle" style="padding: 10px;border: 2px solid lightgrey;margin-right: 420px;margin-left: 480px; margin-bottom: 25px;background-color:#f3f3f8;color:#141313;">
				<form action="" method="post" class="text-center">
					...
					<button name="submit" type="submit" style="margin-right:100px;padding: 5px 25px; border-radius: 4px;">Login</button> <br>
