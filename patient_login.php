...
<?php include('header.php'); ?>
	...
	<div class="login" style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;">Patient Login</h3>
			<div class="formstyle" style="float:right;padding:10px;border: 1px solid lightgrey;margin-right:500px;margin-bottom:20px;background-color:#f3f3f8;color:#141313;">
				<form action="" method="post" class="text-center form-group">
					...
					<button name="submit" type="submit" style="margin-left: -80px;width: 85px;border-radius: 3px;">Login</button> <br>
